package com.example.gd10_d_10866
...
import com.example.gd10_d_10866.databinding.ActivityDetailMahasiswaBinding
...
class DetailMahasiswaActivity : AppCompatActivity() {
    ...
    fun deleteData(nim: String) {
        ...
        builder.setMessage("Anda Yakin mau hapus?? Saya nggak yakin loh.")
            .setCancelable(false)
